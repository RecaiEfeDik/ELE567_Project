...
def EvaluateModel(x_test, compression_ratios, snr, mode='multiple'):
    if mode=='single':
        ...
        path = '/content/checkpoints/CompRatio{0}_Adaptive/Autoencoder.keras'.format(comp_ratio)
...
history = plot_model(x_test, compression_ratios, title='AWGN Channel', x_lablel='k/n', y_label='PSNR (dB)')   
