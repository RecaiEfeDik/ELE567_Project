...
for comp_ratio in compression_ratios:
    ...
    _ = TrainAutoEncoder(x_train, x_test, nb_epoch=3, comp_ratio=comp_ratio, batch_size=16, c=c, snr=10, saver_step=2)
    #_ = TrainAutoEncoder(x_train, x_test, nb_epoch=75, comp_ratio=comp_ratio, batch_size=16, c=c, snr=10, quantization_bits=8, saver_step=25)
